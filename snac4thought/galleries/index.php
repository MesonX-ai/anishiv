<?php
	...
	if ($thumbnail_creation && isset($_GET['thumbnails'])) {
		...
		if (!is_writable('../cache/')) {
			...
			if (!$writable) die('<html><head><title>Welcome to Anishiv's World | Snac 4 Thought</title><style>p{padding:10px;color:#fff;background:transparent;}a{padding:10px;color:#fc0;}a:hover{color:#fff;}</style>
<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-5722481263099352"
     crossorigin="anonymous"></script>
</head><body><p><a href="javascript:history.go(-1);">&#171; back</a> AniShiv says: <b>/cache/ folder is not writable so thumbnails cannot be created until it is writable</b></p></body></html>');
		}
?>
<style>
	.red { color: #f30; }
...
<html>
<head>
	<title>AniShiv's World | Snac 4 Thought</title>
...
<?php
	...
	//// IF NOT ACTIVE, DIE AND TELL ////
		...
		die('<html><head><title>AniShiv's World | Snac 4 Thought</title><style>p{padding:10px;color:#fff;background:transparent;}a{padding:10px;color:#fc0;}a:hover{color:#fff;}</style></head><body><p><a href="javascript:history.go(-1);">&#171; back</a> AniShiv says: <b>this directory is private, sorry...</b></p></body></html>');
	}
