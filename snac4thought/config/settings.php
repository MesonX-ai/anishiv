 ...
 */
	 ...
	 * VALUES: [ <http://url> ]
  	 * EXAMPLE: 'http://www.anishiv.com/snac4thought/gallery'
  	 * (need to set for proper gallery inclusion in a website)
 	 * NOTE: DON'T ADD A SLASH AT THE END!! */
 	$settings['minishowcase_url'] = "http://www.anishiv.com/snac4thought/gallery";
	...
	$settings['preview_thumbnail_quality'] = 70;
	...
	$settings['gallery_default_name'] = 'anishiv';
	 ...
	 * any single quote */
	$settings['gallery_footer'] = 'Powered by <a href="http://www.mesonsoft.com" target="_blank">Mesonsoft</a>';
